...
void main(void) {
  ...
  float t = time * 0.1;
  vec3 ang = vec3(sin(t*3.0)*0.2, -5.0+sin(t)*0.2+0.3, t) * 0.1;
  vec3 ori = vec3(0.0, 2.0, t*1.5);
  ...
  vec3 light = normalize(vec3(150.0, 551.0, 500.0));
  vec3 color = mix(
    getSkyColor(dir),
  ...
  useEffect(() => {
    ...
    import('p5').then(({ default: P5 }) => {
      instance = new P5((p: P5) => {
        ...
        p.draw = () => {
          p.shader(sea)
          sea.setUniform('resolution', [p.width, p.height])
